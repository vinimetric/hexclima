...
1. [O que é o hexclima](#o-que-é-o-memclimate)
2. [O que o modelo faz?](#o-que-o-modelo-faz-e-o-que-não-faz)
3. [Arquitetura](#arquitetura)
4. [Datasets](#fontes-de-dados)
5. [Estrutura do Projeto](#estrutura-do-projeto)
6. [Executando o Projeto](#instalação-e-execução)
